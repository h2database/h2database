...
> ----------- ----------- ------------------- -------------- ------------------ ---------------- ---------------- -------------- ---------------- --------------
> D           YES         BY DEFAULT          1              1                  1000             1                NO             3                32
> rows: 1
...
SELECT COLUMN_NAME, DATA_TYPE, IS_IDENTITY, IDENTITY_START, IDENTITY_INCREMENT, IDENTITY_MAXIMUM, IDENTITY_MINIMUM,
    IDENTITY_CYCLE, IDENTITY_CURRENT, IDENTITY_CACHE
    FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TEST' AND COLUMN_NAME = 'ID';
> COLUMN_NAME DATA_TYPE IS_IDENTITY IDENTITY_START IDENTITY_INCREMENT IDENTITY_MAXIMUM    IDENTITY_MINIMUM IDENTITY_CYCLE IDENTITY_CURRENT IDENTITY_CACHE
> ----------- --------- ----------- -------------- ------------------ ------------------- ---------------- -------------- ---------------- --------------
> ID          BIGINT    YES         10             2                  9223372036854775807 3                YES            10               16
> rows: 1
...
> COLUMN_NAME DATA_TYPE IS_IDENTITY IDENTITY_START IDENTITY_INCREMENT IDENTITY_MAXIMUM IDENTITY_MINIMUM IDENTITY_CYCLE IDENTITY_CURRENT IDENTITY_CACHE
> ----------- --------- ----------- -------------- ------------------ ---------------- ---------------- -------------- ---------------- --------------
> ID          INTEGER   YES         10             2                  2147483647       3                YES            10               16
> rows: 1
...
SELECT COLUMN_NAME, IS_IDENTITY, IDENTITY_GENERATION, IDENTITY_CURRENT
    FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TEST' AND COLUMN_NAME = 'ID';
> COLUMN_NAME IS_IDENTITY IDENTITY_GENERATION IDENTITY_CURRENT
> ----------- ----------- ------------------- ----------------
> ID          YES         ALWAYS              1
> rows: 1
