...
>> SELECT RANK() OVER (ORDER BY NULL) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
...
>> SELECT DENSE_RANK() OVER (ORDER BY NULL) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */

SELECT DENSE_RANK() OVER (ORDER BY 'a') FROM TEST;
> DENSE_RANK() OVER (ORDER BY NULL)
> ---------------------------------
> 1
> 1
> 1
...
>> SELECT PERCENT_RANK() OVER () FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
...
>> SELECT CUME_DIST() OVER () FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
