...
SELECT I, RSHIFT(CAST(-128 AS TINYINT), I), RSHIFT(CAST(1 AS TINYINT), I) FROM
    (VALUES -111, -8, -7, -1, 0, 1, 7, 8, 111) T(I) ORDER BY I;
> I    RSHIFT(-128, I) RSHIFT(1, I)
> ---- --------------- ------------
> -111 0               0
> -8   0               0
> -7   0               -128
...
SELECT I, RSHIFT(CAST(-32768 AS SMALLINT), I), RSHIFT(CAST(1 AS SMALLINT), I) FROM
    (VALUES -111, -16, -15, -1, 0, 1, 15, 16, 111) T(I) ORDER BY I;
> I    RSHIFT(-32768, I) RSHIFT(1, I)
> ---- ----------------- ------------
> -111 0                 0
> -16  0                 0
> -15  0                 -32768
...
SELECT I, RSHIFT(CAST(-2147483648 AS INTEGER), I), RSHIFT(CAST(1 AS INTEGER), I) FROM
    (VALUES -111, -32, -31, -1, 0, 1, 31, 32, 111) T(I) ORDER BY I;
> I    RSHIFT(-2147483648, I) RSHIFT(1, I)
> ---- ---------------------- ------------
> -111 0                      0
> -32  0                      0
> -31  0                      -2147483648
...
SELECT I, RSHIFT(CAST(-9223372036854775808 AS BIGINT), I), RSHIFT(CAST(1 AS BIGINT), I) FROM
    (VALUES -111, -64, -63, -1, 0, 1, 63, 64, 111) T(I) ORDER BY I;
> I    RSHIFT(-9223372036854775808, I) RSHIFT(1, I)
> ---- ------------------------------- --------------------
> -111 0                               0
> -64  0                               0
