...
> ------------------ ------------------- ----------------- ------------------ -------------------- ---------------------------
> INTERVAL '1' YEAR  INTERVAL '1' MONTH  INTERVAL '1' DAY  INTERVAL '1' HOUR  INTERVAL '1' MINUTE  INTERVAL '1.123456' SECOND
> INTERVAL '-1' YEAR INTERVAL '-1' MONTH INTERVAL '-1' DAY INTERVAL '-1' HOUR INTERVAL '-1' MINUTE INTERVAL '-1.123456' SECOND
> rows (ordered): 2
...
> I07                           I08                          I09                               I10
> ----------------------------- ---------------------------- --------------------------------- -------------------------------------------
> INTERVAL '1-2' YEAR TO MONTH  INTERVAL '1 02' DAY TO HOUR  INTERVAL '1 02:03' DAY TO MINUTE  INTERVAL '1 02:03:04.123456' DAY TO SECOND
> INTERVAL '-1-2' YEAR TO MONTH INTERVAL '-1 02' DAY TO HOUR INTERVAL '-1 02:03' DAY TO MINUTE INTERVAL '-1 02:03:04.123456' DAY TO SECOND
> rows (ordered): 2
...
> I11                             I12                                       I12
> ------------------------------- ----------------------------------------- -----------------------------------------
> INTERVAL '1:02' HOUR TO MINUTE  INTERVAL '1:02:03.123456' HOUR TO SECOND  INTERVAL '1:02:03.123456' HOUR TO SECOND
> INTERVAL '-1:02' HOUR TO MINUTE INTERVAL '-1:02:03.123456' HOUR TO SECOND INTERVAL '-1:02:03.123456' HOUR TO SECOND
> rows (ordered): 2
...
>> INTERVAL '-26:03:04.123456' HOUR TO SECOND

SELECT CAST(INTERVAL '-93784.123456789' SECOND AS INTERVAL MINUTE(4) TO SECOND);
>> INTERVAL '-1563:04.123456' MINUTE TO SECOND
...
>> INTERVAL '-1 06:02:04.123456' DAY TO SECOND
...
>> INTERVAL '-1802:04.123456' MINUTE TO SECOND
...
>> INTERVAL '-1 06:03:04.123456' DAY TO SECOND
...
>> INTERVAL '-30:03:04.123456' HOUR TO SECOND
...
>> INTERVAL '999999999999999998.999999' SECOND
...
>> INTERVAL '999999999999999998 23:59:59.999999' DAY TO SECOND
...
>> INTERVAL '999999999999999998:59:59.999999' HOUR TO SECOND
...
>> INTERVAL '999999999999999998:59.999999' MINUTE TO SECOND
...
>> INTERVAL '10:07:24.44444' HOUR TO SECOND
