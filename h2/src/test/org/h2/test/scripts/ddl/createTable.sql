...
CREATE TABLE TEST1(ID BIGINT(20) NOT NULL PRIMARY KEY COMMENT 'COMMENT1', FIELD_NAME VARCHAR(100) NOT NULL COMMENT 'COMMENT2');
> ok
...
> CREATE CACHED TABLE "PUBLIC"."TEST1"( "ID" BIGINT NOT NULL COMMENT 'COMMENT1', "FIELD_NAME" VARCHAR(100) NOT NULL COMMENT 'COMMENT2' );
