...
SELECT COLUMN_NAME, IS_IDENTITY, IDENTITY_GENERATION, IDENTITY_START, IDENTITY_INCREMENT, IDENTITY_MAXIMUM,
    IDENTITY_MINIMUM, IDENTITY_CYCLE, IDENTITY_CURRENT, IDENTITY_CACHE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TEST';
> COLUMN_NAME IS_IDENTITY IDENTITY_GENERATION IDENTITY_START IDENTITY_INCREMENT IDENTITY_MAXIMUM IDENTITY_MINIMUM IDENTITY_CYCLE IDENTITY_CURRENT IDENTITY_CACHE
> ----------- ----------- ------------------- -------------- ------------------ ---------------- ---------------- -------------- ---------------- --------------
> D           YES         ALWAYS              1              1                  1000             1                NO             3                32
> rows: 1
...
> ---------------------------------------------------
> -- 0 +/- SELECT COUNT(*) FROM PUBLIC.TEST;
> CREATE MEMORY TABLE "PUBLIC"."TEST"( "D" INTEGER );
> CREATE USER IF NOT EXISTS "SA" PASSWORD '' ADMIN;
> rows: 3
