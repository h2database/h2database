...
>> SELECT "PUBLIC"."SYSTEM_RANGE"."X" FROM SYSTEM_RANGE(1, 10) /* PUBLIC.RANGE_INDEX: X IN((SELECT 1 FROM SYSTEM_RANGE(1, 1) /++ PUBLIC.RANGE_INDEX ++/), (SELECT 2 FROM SYSTEM_RANGE(1, 1) /++ PUBLIC.RANGE_INDEX ++/)) */ WHERE "X" IN((SELECT 1 FROM SYSTEM_RANGE(1, 1) /* PUBLIC.RANGE_INDEX */), (SELECT 2 FROM SYSTEM_RANGE(1, 1) /* PUBLIC.RANGE_INDEX */))
