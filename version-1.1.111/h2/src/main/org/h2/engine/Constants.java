...
public class Constants {
     ...
     */
    public static final int BUILD_ID = 111;

    /**
     * The build id of the last stable release.
     */
    public static final int BUILD_ID_STABLE = 110;

    /**
     * The build date is updated for each public release.
     */
    public static final String BUILD_DATE = "2009-04-10";

    /**
     * The build date is updated for each public release.
     */
    public static final String BUILD_DATE_STABLE = "2009-04-03";
