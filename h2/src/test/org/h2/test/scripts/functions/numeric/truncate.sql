...
SELECT TRUNC(1, 100000);
>> 1

CREATE TABLE T1(N NUMERIC(10, 2), D DECFLOAT(10), I INTEGER) AS VALUES (99999999.99, 99999999.99, 10);
> ok

SELECT TRUNC(N, -1) NN, TRUNC(N) N0, TRUNC(N, 1) N1, TRUNC(N, 2) N2, TRUNC(N, 3) N3, TRUNC(N, 100000) NL,
...
CREATE TABLE T2 AS SELECT TRUNC(N, -1) NN, TRUNC(N) N0, TRUNC(N, 1) N1, TRUNC(N, 2) N2, TRUNC(N, 3) N3, TRUNC(N, 100000) NL,
    TRUNC(D) D0, TRUNC(D, 2) D2, TRUNC(D, 3) D3,
    TRUNC(I) I0, TRUNC(I, 1) I1, TRUNC(I, I) II FROM T1;
> ok
