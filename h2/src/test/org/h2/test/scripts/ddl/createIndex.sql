...
CREATE INDEX IDX_INV ON TEST(B) INVISIBLE;
> ok

SELECT IS_VISIBLE FROM INFORMATION_SCHEMA.INDEXES WHERE INDEX_NAME = 'IDX_INV';
> IS_VISIBLE
> ----------
> FALSE
> rows: 1

CREATE INDEX IDX_VIS ON TEST(A) VISIBLE;
> ok

SELECT IS_VISIBLE FROM INFORMATION_SCHEMA.INDEXES WHERE INDEX_NAME = 'IDX_VIS';
> IS_VISIBLE
> ----------
> TRUE
> rows: 1
