...
VALUES CAST(ARRAY[ARRAY[1, 2], ARRAY[3, 4]] AS ARRAY[2] ARRAY[1]);
>> [[1, 2]]

VALUES CAST(ARRAY[ARRAY[1, 2], ARRAY[3, 4]] AS ARRAY[1] ARRAY[2]);
>> [[1], [3]]
...
SELECT COLUMN_TYPE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'TEST';
>> BIGINT ARRAY
