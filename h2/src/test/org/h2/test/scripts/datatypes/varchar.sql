...
> ----------- --------- --------------------------
> C1          VARCHAR   VARCHAR
> C2          VARCHAR   CHARACTER VARYING
> C3          VARCHAR   VARCHAR2
> C4          VARCHAR   NVARCHAR
> C5          VARCHAR   NVARCHAR2
> C6          VARCHAR   VARCHAR_CASESENSITIVE
> C7          VARCHAR   LONGVARCHAR
> C8          VARCHAR   TID
> C9          VARCHAR   CHAR VARYING
> C10         VARCHAR   NCHAR VARYING
> C11         VARCHAR   NATIONAL CHARACTER VARYING
> C12         VARCHAR   NATIONAL CHAR VARYING
> rows (ordered): 12
