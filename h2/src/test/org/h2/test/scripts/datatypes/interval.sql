...
SELECT CAST(INTERVAL '10.123457' SECOND AS NUMERIC);
>> 10.123457
...
SELECT CAST(INTERVAL '10-1' YEAR TO MONTH AS NUMERIC);
>> 10.08
...
SELECT CAST(INTERVAL '10 02' DAY TO HOUR AS NUMERIC);
>> 10.08
...
SELECT CAST(INTERVAL '10 02:57' DAY TO MINUTE AS NUMERIC);
>> 10.1229
...
SELECT CAST(INTERVAL '10 02:57:46.66658' DAY TO SECOND AS NUMERIC);
>> 10.12345678912037
...
SELECT CAST(INTERVAL '10:07' HOUR TO MINUTE AS NUMERIC);
>> 10.12
...
SELECT CAST(INTERVAL '10:07:24.444441' HOUR TO SECOND AS NUMERIC);
>> 10.1234567891667
...
SELECT CAST(INTERVAL '10:07.407407' MINUTE TO SECOND AS NUMERIC);
>> 10.12345678333
