...
> C7          2005      CLOB      NTEXT
> C8          2005      CLOB      NCLOB
> C9          2005      CLOB      CHAR LARGE OBJECT
> C10         2005      CLOB      NCHAR LARGE OBJECT
> C11         2005      CLOB      NATIONAL CHARACTER LARGE OBJECT
> rows (ordered): 11
...
EXPLAIN VALUES (CAST('' AS CLOB(0)), CAST(' ' AS CLOB(1)));
>> VALUES (CAST('' AS CLOB(0)), CAST(' ' AS CLOB(1)))
