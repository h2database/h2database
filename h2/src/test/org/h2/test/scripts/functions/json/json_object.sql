...
>> SELECT JSON_OBJECT('name': "V" NULL ON NULL) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
...
>> SELECT JSON_OBJECT("ABSENT": 1 NULL ON NULL) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */

EXPLAIN SELECT JSON_OBJECT(WITHOUT : 1) FROM TEST;
>> SELECT JSON_OBJECT("WITHOUT": 1 NULL ON NULL) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
