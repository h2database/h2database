...
SELECT LN(0.5) VH, LN(1) V1, LN(2) V2, ROUND(LN(3), 14) V3, LN(10) V10;
> VH                  V1  V2                 V3               V10
> ------------------- --- ------------------ ---------------- -----------------
> -0.6931471805599453 0.0 0.6931471805599453 1.09861228866811 2.302585092994046
> rows: 1

SELECT LOG(2, 0.5) VH, LOG(2, 1) V1, LOG(2, 2) V2, ROUND(LOG(2, 3), 14) V3, LOG(2, 10) V10, LOG(2, 64) V64;
> VH   V1  V2  V3               V10                V64
> ---- --- --- ---------------- ------------------ ---
> -1.0 0.0 1.0 1.58496250072116 3.3219280948873626 6.0
> rows: 1
...
SELECT LOG(0.5) VH, LOG(1) V1, LOG(2) V2, ROUND(LOG(3), 14) V3, LOG(10) V10;
> VH                  V1  V2                 V3               V10
> ------------------- --- ------------------ ---------------- -----------------
> -0.6931471805599453 0.0 0.6931471805599453 1.09861228866811 2.302585092994046
> rows: 1
...
SELECT LOG(0.5, 2) VH, LOG(1, 2) V1, LOG(2, 2) V2, ROUND(LOG(3, 2), 14) V3, LOG(10, 2) V10, LOG(64, 2) V64;
> VH   V1  V2  V3               V10                V64
> ---- --- --- ---------------- ------------------ ---
> -1.0 0.0 1.0 1.58496250072116 3.3219280948873626 6.0
> rows: 1
