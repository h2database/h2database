...
> T                          T0                  T1                    T2
> -------------------------- ------------------- --------------------- ----------------------
> 2000-01-01 08:00:00.123456 2000-01-01 08:00:00 2000-01-01 08:00:00.1 2000-01-01 08:00:00.12
> rows: 1

SELECT T3, T4, T5, T6 FROM TEST;
> T3                      T4                       T5                        T6
> ----------------------- ------------------------ ------------------------- --------------------------
> 2000-01-01 08:00:00.123 2000-01-01 08:00:00.1234 2000-01-01 08:00:00.12345 2000-01-01 08:00:00.123456
> rows: 1

SELECT T7, T8, T9 FROM TEST;
> T7                          T8                           T9
> --------------------------- ---------------------------- -----------------------------
> 2000-01-01 08:00:00.1234567 2000-01-01 08:00:00.12345678 2000-01-01 08:00:00.123456789
> rows: 1
