...
CREATE INDEX IDX_INV ON TEST(NAME) INVISIBLE;
> ok

EXPLAIN SELECT * FROM TEST WHERE NAME = 'a';
>> SELECT "PUBLIC"."TEST"."ID", "PUBLIC"."TEST"."NAME" FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */ WHERE "NAME" = 'a'

EXPLAIN SELECT * FROM TEST USE INDEX (IDX_INV) WHERE NAME = 'a';
>> SELECT "PUBLIC"."TEST"."ID", "PUBLIC"."TEST"."NAME" FROM "PUBLIC"."TEST" USE INDEX ("IDX_INV") /* PUBLIC.IDX_INV: NAME = 'a' */ WHERE "NAME" = 'a'
