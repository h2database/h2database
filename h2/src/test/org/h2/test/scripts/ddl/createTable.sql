...
CREATE TABLE IF NOT EXISTS TEST(ID BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '字典ID', FIELD_NAME VARCHAR(100) NOT NULL COMMENT '字段名称', TABLE_NAME VARCHAR(100) NOT NULL COMMENT '表名');
> ok
