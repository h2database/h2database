...
>> SELECT JSON_ARRAYAGG("J" ABSENT ON NULL) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
...
>> SELECT JSON_ARRAYAGG("J" FORMAT JSON ABSENT ON NULL) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */

EXPLAIN SELECT JSON_ARRAYAGG(J FORMAT JSON ORDER BY ID DESC ABSENT ON NULL) FROM TEST;
>> SELECT JSON_ARRAYAGG("J" FORMAT JSON ABSENT ON NULL ORDER BY "ID" DESC) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
