...
>> SELECT JSON_OBJECTAGG("N": "J" NULL ON NULL) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
...
>> SELECT JSON_OBJECTAGG("N": "J" NULL ON NULL WITH UNIQUE KEYS) FROM "PUBLIC"."TEST" /* PUBLIC.TEST.tableScan */
