...
ALTER TABLE CHILD ADD CONSTRAINT D_C FOREIGN KEY(P) REFERENCES PARENT(K) ON DELETE CASCADE;
> ok

ALTER TABLE CHILD ADD CONSTRAINT D_R FOREIGN KEY(P) REFERENCES PARENT(K) ON DELETE RESTRICT;
> ok

ALTER TABLE CHILD ADD CONSTRAINT D_A FOREIGN KEY(P) REFERENCES PARENT(K) ON DELETE NO ACTION;
> ok

ALTER TABLE CHILD ADD CONSTRAINT D_D FOREIGN KEY(P) REFERENCES PARENT(K) ON DELETE SET DEFAULT;
> ok

ALTER TABLE CHILD ADD CONSTRAINT D_N FOREIGN KEY(P) REFERENCES PARENT(K) ON DELETE SET NULL;
> ok

ALTER TABLE CHILD ADD CONSTRAINT U_C FOREIGN KEY(P) REFERENCES PARENT(K) ON UPDATE CASCADE;
> ok

ALTER TABLE CHILD ADD CONSTRAINT U_R FOREIGN KEY(P) REFERENCES PARENT(K) ON UPDATE RESTRICT;
> ok

ALTER TABLE CHILD ADD CONSTRAINT U_A FOREIGN KEY(P) REFERENCES PARENT(K) ON UPDATE NO ACTION;
> ok

ALTER TABLE CHILD ADD CONSTRAINT U_D FOREIGN KEY(P) REFERENCES PARENT(K) ON UPDATE SET DEFAULT;
> ok

ALTER TABLE CHILD ADD CONSTRAINT U_N FOREIGN KEY(P) REFERENCES PARENT(K) ON UPDATE SET NULL;
> ok
...
> --------------- ----------- -----------
> D_A             NO ACTION   NO ACTION
> D_C             NO ACTION   CASCADE
> D_D             NO ACTION   SET DEFAULT
> D_N             NO ACTION   SET NULL
> D_R             NO ACTION   RESTRICT
> U_A             NO ACTION   NO ACTION
> U_C             CASCADE     NO ACTION
> U_D             SET DEFAULT NO ACTION
> U_N             SET NULL    NO ACTION
> U_R             RESTRICT    NO ACTION
> rows: 10
...
-- Test constraint stealing an invisible index
CREATE TABLE TEST_STEAL(ID INT, NAME VARCHAR(255));
> ok

CREATE UNIQUE INDEX IDX_STEAL ON TEST_STEAL(NAME) INVISIBLE;
> ok

SELECT IS_VISIBLE FROM INFORMATION_SCHEMA.INDEXES WHERE INDEX_NAME = 'IDX_STEAL';
> IS_VISIBLE
> ----------
> FALSE
> rows: 1

ALTER TABLE TEST_STEAL ADD CONSTRAINT U_STEAL UNIQUE(NAME);
> ok
